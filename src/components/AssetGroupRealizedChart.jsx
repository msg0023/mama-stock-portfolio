...
import { buildAssetGroupRealizedSeries } from '../utils/calculations';
...
export default function AssetGroupRealizedChart({ enrichedStocks }) {
  const data = buildAssetGroupRealizedSeries(enrichedStocks);
  ...
  return (
    <div className="card" style={{ marginBottom: 16 }}>
      ...
      <p style={{ fontSize: 12, color: '#94a3b8', marginBottom: 12 }}>
        매도 거래가 누적되면서 실현손익이 어떻게 쌓였는지 보여줍니다.
      </p>
